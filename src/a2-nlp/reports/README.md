...
| **12** | **[Poster build sheet](12-poster-build-sheet.md)** | Not an investigation — the translation from written panels to a physical 3ft × 4ft board: what goes in each cell, at what point size, which figure it carries, and what has to be true before it can be printed. Numbered 12 because report 11 was taken; "report 11" in prose always means the dev-split one. |
