"""Build four paired 3×4-foot A2-NLP poster concepts from the UW templates.

Outputs are editable PowerPoint files plus print PDFs and PNG previews.
The layout functions use recursive/axis-aligned splits: each design starts
with one content rectangle and partitions it into a small number of visual
regions before placing text or figures.
"""
